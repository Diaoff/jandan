...
1.  jandanCommentTask.pullComments(26402,'wu.start.id');
2.  jandanCommentTask.pullComments(21183,'sui.start.id');
3.  jandanCommentTask.pullComments(102312,'tree.start.id');
4.  jandanCommentTask.pullComments(108629,'girl.start.id');
